...
use smoltcp::wire::{IpCidr, IpProtocol, Ipv4Address, Ipv4Packet, Ipv6Packet};
...
fn pcap_replay_targeted_syn() {
    ...
    let egress = inject_tcp_packet(
        &mut stack,
        Ipv4Address::new(10, 13, 37, 2),
        &tcp_repr,
        now,
    );
...
fn pcap_replay_full_handshake() {
    ...
    use smoltcp::wire::{Ipv4Packet, TcpControl, TcpPacket, TcpRepr, TcpSeqNumber};
