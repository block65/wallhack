...
use protobuf::v2::{EntryNodeInstruction, ExitNodeResponse, TunnelMessage};
...
fn make_response_with_payload(payload_size: usize) -> ExitNodeResponse {
	ExitNodeResponse {
		response: Some(protobuf::v2::exit_node_response::Response::UdpResponse(
			protobuf::v2::UdpResponse {
				response: Some(protobuf::v2::udp_response::Response::DataRecv(
					protobuf::v2::UdpDataRecvResponse {
