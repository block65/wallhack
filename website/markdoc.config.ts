...
export default defineMarkdocConfig({
  ...
  tags: {
    ...
    callout: {
      ...
      attributes: {
        type: { type: String, default: 'info', matches: ['info', 'warning', 'note', 'tip'] },
        title: { type: String },
      },
    },
    card: {
    ...
    badge: {
      ...
      attributes: {
        variant: { type: String, default: 'outline', matches: ['outline', 'secondary', 'default'] },
    ...
    featurelist: {
      ...
      attributes: {
        ...
        icon: { type: String, default: 'border', matches: ['check', 'border', 'bullet'] },
      },
    },
    separator: {
